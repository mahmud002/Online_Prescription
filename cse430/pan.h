...
#define Air1	(sizeof(P1) - Offsetof(P1, n) - 1*sizeof(int))

#define Psieve	((P0 *)_this)
typedef struct P0 { /* sieve */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, n) - 1*sizeof(int))
