...
{	/* int i; */
	printf("global vars:\n");
	printf("	mtype  enterProfile:	14\n");
	printf("	mtype  addinfo:	13\n");
	printf("	mtype  checkAuth:	12\n");
	printf("	mtype  authSuccess:	11\n");
	printf("	mtype  loadProfile:	10\n");
	printf("	mtype  editProfile:	9\n");
	printf("	mtype  returnForm:	8\n");
	printf("	mtype  insertInfo:	7\n");
	printf("	mtype  saveInfo:	6\n");
	printf("	mtype  updateSuccess:	5\n");
...
printm(int x, char *s)
{
	...
	case 5: Printf("updateSuccess"); return;
	case 6: Printf("saveInfo"); return;
	case 7: Printf("insertInfo"); return;
	case 8: Printf("returnForm"); return;
	case 9: Printf("editProfile"); return;
	case 10: Printf("loadProfile"); return;
	case 11: Printf("authSuccess"); return;
	case 12: Printf("checkAuth"); return;
	case 13: Printf("addinfo"); return;
	case 14: Printf("enterProfile"); return;
