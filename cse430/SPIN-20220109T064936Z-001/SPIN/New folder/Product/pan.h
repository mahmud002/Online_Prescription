...
#define PanSource	"testProduct.pml"
...
#define _nstates2	7	/* Database */
#define minseq2	26
#define maxseq2	31
#define _endstate2	6

#define _nstates1	16	/* Product */
#define minseq1	11
#define maxseq1	25
#define _endstate1	15

#define _nstates0	12	/* User */
#define minseq0	0
#define maxseq0	10
...
#define PDatabase	((P2 *)_this)
typedef struct P2 { /* Database */
...
#define PProduct	((P1 *)_this)
typedef struct P1 { /* Product */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
