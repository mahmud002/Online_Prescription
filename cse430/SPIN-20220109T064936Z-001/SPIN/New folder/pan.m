...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 2: /* generic 'else' */
		...
		_m = 3; goto P999;
		 ...
		 /* PROC Database */
	case 3: // STATE 1 - temp.pml:25 - [to_database?check] (0:0:0 - 1)
		reached[2][1] = 1;
		...
		;
		_m = 4; goto P999; /* 0 */
	case 4: // STATE 2 - temp.pml:26 - [to_signup!added] (0:0:0 - 1)
		IfNotBlocked
		reached[2][2] = 1;
		...
		_m = 2; goto P999; /* 0 */
		 ...
		 /* PROC Signup */
	case 5: // STATE 1 - temp.pml:15 - [to_signup?signuph] (0:0:0 - 1)
		reached[1][1] = 1;
		...
		;
		_m = 4; goto P999; /* 0 */
	case 6: // STATE 2 - temp.pml:16 - [to_signup?addinfo] (0:0:0 - 1)
		reached[1][2] = 1;
		if (q_len(now.to_signup) == 0) continue;
		...
		;
		_m = 4; goto P999; /* 0 */
	case 7: // STATE 3 - temp.pml:17 - [to_database!check] (0:0:0 - 1)
		IfNotBlocked
		reached[1][3] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 8: // STATE 4 - temp.pml:18 - [to_signup?added] (0:0:0 - 1)
		reached[1][4] = 1;
		if (q_len(now.to_signup) == 0) continue;
		...
		;
		_m = 4; goto P999; /* 0 */
	case 9: // STATE 5 - temp.pml:19 - [to_user!ack] (0:0:0 - 1)
		IfNotBlocked
		reached[1][5] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 10: // STATE 6 - temp.pml:20 - [to_signup?smsg] (0:0:0 - 1)
		reached[1][6] = 1;
		if (q_len(now.to_signup) == 0) continue;
		...
		_m = 4; goto P999; /* 0 */
		 ...
		 /* PROC User */
	case 11: // STATE 1 - temp.pml:7 - [to_signup!signuph] (0:0:0 - 1)
		IfNotBlocked
		reached[0][1] = 1;
		if (q_full(now.to_signup))
			continue;
		...
		_m = 2; goto P999; /* 0 */
	case 12: // STATE 2 - temp.pml:8 - [to_signup!addinfo] (0:0:0 - 1)
		IfNotBlocked
		reached[0][2] = 1;
		if (q_full(now.to_signup))
			continue;
		...
		_m = 2; goto P999; /* 0 */
	case 13: // STATE 3 - temp.pml:9 - [to_user?ack] (0:0:0 - 1)
		reached[0][3] = 1;
		...
		;
		_m = 4; goto P999; /* 0 */
	case 14: // STATE 4 - temp.pml:10 - [to_signup!smsg] (0:0:0 - 1)
		IfNotBlocked
		reached[0][4] = 1;
		if (q_full(now.to_signup))
			continue;
